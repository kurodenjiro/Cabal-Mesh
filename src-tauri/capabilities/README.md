...
|---|---|---|
| `desktop.json` | linux, macOS, windows | `core:default`, `opener:default`, the same 23 app commands as mobile.json |
| `mobile.json` | iOS, android | `core:default` plus the same 23 app commands as desktop.json |
